        ...
        <div key={section.title + index} className="p-1">
                ...
                >
                  ...
                  {!collapsed && (
                    <div className="flex justify-between items-center w-full group">
                      ...
                      {section.hoverAnimate !== false && (
                        <BsThreeDotsVertical className="h-4 w-4 flex-shrink-0 text-gray-muted opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      )}
                    </div>
                  )}
                </div>
          ...
          {section.addOption && !collapsed && (
            <div className="my-2 pl-2 flex items-center gap-2">
              <span className="text-xl w-6 h-6 flex text-primary items-center justify-center rounded-full border-[1px] border-gray-muted px-1 p-1">
                <IoAddOutline />
              </span>
