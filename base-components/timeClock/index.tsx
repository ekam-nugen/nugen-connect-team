  ...
  return (
    <div className="flex justify-start p-3">
      <Card className="h-auto rounded-lg w-full border-gray-200 shadow-none border hover:shadow-md">
        <div className="flex justify-center bg-gradient-to-b from-accent to-blue-50 pt-7">
          <Image
        ...
        <div className="p-4">
          ...
          <div className="flex items-center mb-1">
            ...
            <div className="flex items-center space-x-2">
              <div className="rounded-full h-6 w-6 flex justify-center items-center text-xs font-bold bg-[#689F38] text-accent">
                {nameTitle}
              </div>
        ...
        <div className=" border-slate-400 flex items-center py-3 px-3 gap-6">
          ...
          <Button className="bg-primary hover:bg-primary-hover text-accent rounded-3xl text-base capitalize px-8 shadow shadow-primary hover:shadow-primary-hover hover:shadow-sm">
            {buttonText}
          </Button>
        </div>
      </Card>
